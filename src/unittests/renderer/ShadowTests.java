...
public class ShadowTests {
   ...
   private final Camera.Builder camera     = Camera.getBuilder()
      ...
      .setLocation(new Point(0, 0, 1000)).setVpDistance(2000)
      .setVpSize(400, 400)
   ...
   public void sphereTriangleMove1() {
      sphereTriangleHelper("shadowSphereTriangleMove2", //
    		  new Triangle(new Point(-60, -30, 0), new Point(-30, -60, 0), new Point(-58, -58, -8)), //
                           new Point(-100, -100, 200));
   }
   ...
   public void sphereTriangleMove2() {
      sphereTriangleHelper("shadowSphereTriangleMove1", //
    		  new Triangle(new Point(-50, -20, 0), new Point(-20,-50,0), new Point(-45,-45,-8)), //
              new Point(-100, -100, 200));
   }
   ...
   public void trianglesSphere() {
      ...
      camera.setImageWriter(new ImageWriter("shadowTrianglesSphere", 400, 400))
         .renderImage()
         .writeToImage()
         .build();
   }
